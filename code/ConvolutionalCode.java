...
// 		int i;
// 		// Matrix input = Matrix.generateInput();
// 		Matrix input = new Matrix(10,1);
// 		for (i = 0; i < input.length; i++)
// 		{
// 			for (int j = 0; j < input.entry[0].length; j += 2)
// 				input.entry[i][j] = generator.nextInt(2);
// 		}	
// 		System.out.print(input);
// 				
// 		
//  		Matrix A = new Matrix(input.length, input.length);
//  		Matrix Y, X;
//  		A = A.fillMatrixZero();
// 		Y = A.matrixMultiply(input);
// 		X = Y.gaussseidelIteration(A, 5);
//  		System.out.print(A);
// 		System.out.print(input);
// 		System.out.print(Y);
// 		System.out.print(X);
